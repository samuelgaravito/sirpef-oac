        ...
        return DB::transaction(function () use ($request) {
            try {
                ...
                $memorandum = Memorandum::create([
                    ...
                    'monto' => $request->input('tabla.monto'),
                    'proveedor' => $request->input('tabla.proveedor'),
        ...
        return DB::transaction(function () use ($request, $id) {
            try {
                ...
                $memorandum->update([
                    ...
                    'fecha' => $validated['fecha'],
                    'cuerpo' => $validated['cuerpo'],
                    'monto' => $request->input('tabla.monto') ?? $memorandum->monto,
                    'proveedor' => $request->input('tabla.proveedor') ?? $memorandum->proveedor,
